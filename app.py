...
def save_system(s): save_system(SYSTEM_FILE, s)
...
def generate_question(difficulty):
    ...
    if op == "**":
        ...
        # 📌 แก้ไข: แปลง choices และ answer เป็น String ก่อนส่งกลับ
    ...
    # 📌 แก้ไข: แปลง choices และ answer ของการคำนวณทั่วไปให้เป็น String ก่อนส่งกลับ
    choices = [str(x) for x in choices]
